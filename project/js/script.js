...
$(document).ready(function() {
    ...
    $('#btn1').click(function() {
        ...
        price_cart = 39000 * quantity_cart;
        content_cart = getSourceImg();
        var win = window.open("https://cuongpc206.github.io/project/thanhtoan.html?id_cart=" + id_cart + "&quantity_cart=" + quantity_cart + "&price_cart=" + price_cart.toString() + "&content_cart=" + content_cart);
    });

    $("#giohang_link a").click(function(){
        var win = window.open("https://cuongpc206.github.io/project/giohang.html?id_cart=" + id_cart + "&quantity_cart=" + quantity_cart + "&price_cart=" + price_cart.toString() + "&content_cart=" + content_cart);
    });

    
    $("#back_to_main_dashboard").click(function(){
        window.open("https://cuongpc206.github.io/project/index.html", "_self");
    });
...
$(document).ready(function(){
    ...
    $("#deal_action").click(function(){
        var win = window.open("https://cuongpc206.github.io/project/thanhtoan.html?id_cart=" + id_cart_c + "&quantity_cart=" + quantity_cart_c + "&price_cart=" + price_cart_c.toString() + "&content_cart=" + content_cart_c);
    }); 
